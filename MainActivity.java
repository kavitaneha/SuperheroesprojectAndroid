...
import com.karumi.superheroesproject.di.MainModule;
...
@RunWith(AndroidJUnit4.class) @LargeTest public class SuperHeroDetailActivityTests {
  ...
  private SuperHero givenThereIsASuperHero(boolean isAvenger) {
    ...
    String superHeroPhoto = "https://kavitascreenshor/c/60/55b6b29ef25fb.jpg";
    String superHeroDescription = "Super Hero Description";
    SuperHero superHero =
        new SuperHero(superHeroName, superHeroPhoto, isAvenger, superHeroDescription, superHeroesGender);
