...
package com.karumi.superheroes.model;
...
public class SuperHeroesRepository {
  ...
  private void fillRepositoryWithFakeData() {
    superHeroes.add(new SuperHero("Scarlet Witch",
        "https://kavitascreenshort/9/c2/237ac2385dfb9.jpg", false,
    ...
    superHeroes.add(
        new SuperHero("Iron Man", "https://kavitascreenshort/67b6a39ef24fa.jpg",
    ...
    superHeroes.add(
        new SuperHero("Wolverine", "https://kavitascreenshort/67b6ab1o3fd7.jpg",
            false,
    ...
    superHeroes.add(
        new SuperHero("Hulk", "https://kavitascreenshort/i/mg/e/e0/537bafa34baa9.jpg",
            true,
    ...
    superHeroes.add(
        new SuperHero("Storm", "https://kavitascreenshort/b0/537bc5f8a8df0.jpg",
            false,
    ...
    superHeroes.add(new SuperHero("Spider-Man",
        "https://kavitascreenshort/f/a1/538cd3628a05e.jpg", true,
    ...
    superHeroes.add(
        new SuperHero("Ultron", "https://kavita_image/a0/537bc7f6d5d23.jpg",
            false,
    ...
    superHeroes.add(new SuperHero("BlackPanther",
        "https://kavitaimage/9/03/537ba26276348.jpg", false,
    ...
    superHeroes.add(new SuperHero("Captain America",
        "http://kavitascreenshort/9/80/537ba5b368b7d.jpg", true,
    ...
    superHeroes.add(new SuperHero("Winter Soldier",
        "https://kavitaimage/prod//7/40/537bca868687c.jpg", false,
    ...
    superHeroes.add(new SuperHero("Captain Marvel",
        "https://imagedestop/u/prod/i/67bab764b4.jpg", false,
    ...
    superHeroes.add(
        new SuperHero("Iron Fist", "kavitascreenshort/35r/67tf3/585bb198765cd32s.jpg",
            false,
